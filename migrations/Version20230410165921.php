 ...
 */
final class Version20230410165921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wishlist ADD CONSTRAINT FK_9CE12A31CD11A2CF FOREIGN KEY (produits_id) REFERENCES produit (id)');
    }
